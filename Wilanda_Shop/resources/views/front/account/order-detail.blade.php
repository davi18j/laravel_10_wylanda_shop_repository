    ...
    <main>
        ...
        <section class=" section-11 ">
            <div class="container  mt-5">
                <div class="row">
                    <div class="col-md-3">
                        @include('front.account.loyout-account.account-panel')
                    </div>
                    <div class="col-md-9">
                        <div class="card">
                                ...
                                <div class="card card-sm">
                                    <div class="card-body bg-light mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-6 col-lg-3">
                                                <!-- Heading -->
                                                <h6 class="heading-xxxs text-muted">Montante</h6>
                                                <!-- Text -->
                                                <p class="mb-0 fs-sm fw-bold">
                            ...
                            <div class="card-footer p-3">
                                ...
                                <!-- Heading -->
                                <h6 class="mb-7 h5 mt-4">Items Pedido ({{$oderItems->count()}})</h6>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-4 col-md-3 col-xl-2">
                                                    ...
                                                    {{-- <a href="product.html"><img src="images/product-1.jpg" alt="..."
                                                            class="img-fluid"></a> --}}
                                                    @php
                                                        $productImage = getProductImage($oderItem->product_id);
                                                    @endphp
                                                ...
                                                <div class="col">
                                                    ...
                                                    <p class="mb-4 fs-sm fw-bold">
                                                        <a class="text-body" href="product.html">{{ $oderItem->name }} x
                                                            {{ $oderItem->qty }}</a> <br>
                                                        <span class="text-muted">{{ number_format($oderItem->total,2) }}</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </li>
